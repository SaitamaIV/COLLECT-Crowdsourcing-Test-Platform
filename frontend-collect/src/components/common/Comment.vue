  ...
  <div class="hbl-fa">
    ...
    <div class="hbl-comm">
      <div style="margin-bottom: 2em">
        <p style="display: inline; margin-left: 3em;margin-right: 1em">点击评分</p>
        <el-rate
    ...
    <div v-for="(item) in commentList" class="hbl-child" v-bind:key="item">
      <div class="reply">
      </div>
      <div class="content">
        <div class="comment-f">
        ...
        <div  class="comment-f">
          <div>
            ...
            <!--            // TODO-->
            <div v-if="item.uid==='wzz'" class="icon author">{{label}}</div>
            <div class="date">
              {{item.submitTime}}
            </div>
          </div>
          <div style="margin-top: 1em;margin-bottom: 1em">
            <el-rate v-model="item.score" disabled show-score text-color="#ff9900" score-template="{value} points"></el-rate>
          </div>
        </div>
      ...
      <div class="children" v-for="(ritem) in item.childrenList" v-bind:key="ritem">
        <div class="reply">
        </div>
        <div class="content">
          <div class="comment-f">
...
export default {
  ...
  methods: { //事件处理器
    ...
    doSend(){
      ...
      console.log("fenshu"+this.score)
      this.$emit("doSend",this.textareaMap[0],this.score);
